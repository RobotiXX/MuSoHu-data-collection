...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_driver_SOURCE_PREFIX /home/robotixx_user/human-pov-navigation/src/velodyne/velodyne_driver)
  set(velodyne_driver_DEVEL_PREFIX /home/robotixx_user/human-pov-navigation/devel)
  ...
  set(velodyne_driver_INSTALL_PREFIX /home/robotixx_user/human-pov-navigation/install)
...
if(NOT "/home/robotixx_user/human-pov-navigation/devel/include;/home/robotixx_user/human-pov-navigation/src/velodyne/velodyne_driver/include " STREQUAL " ")
  set(velodyne_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/robotixx_user/human-pov-navigation/devel/include;/home/robotixx_user/human-pov-navigation/src/velodyne/velodyne_driver/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotixx_user/human-pov-navigation/src/velodyne/velodyne_driver/${idir}'.  ${_report}")
    endif()
