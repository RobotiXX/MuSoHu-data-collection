...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_pointcloud_SOURCE_PREFIX /home/robotixx_user/human-pov-navigation/src/velodyne/velodyne_pointcloud)
  set(velodyne_pointcloud_DEVEL_PREFIX /home/robotixx_user/human-pov-navigation/devel)
  ...
  set(velodyne_pointcloud_INSTALL_PREFIX /home/robotixx_user/human-pov-navigation/install)
...
if(NOT "/home/robotixx_user/human-pov-navigation/devel/include;/home/robotixx_user/human-pov-navigation/src/velodyne/velodyne_pointcloud/include " STREQUAL " ")
  set(velodyne_pointcloud_INCLUDE_DIRS "")
  set(_include_dirs "/home/robotixx_user/human-pov-navigation/devel/include;/home/robotixx_user/human-pov-navigation/src/velodyne/velodyne_pointcloud/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotixx_user/human-pov-navigation/src/velodyne/velodyne_pointcloud/${idir}'.  ${_report}")
    endif()
