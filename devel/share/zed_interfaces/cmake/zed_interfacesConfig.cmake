...
if("TRUE" STREQUAL "TRUE")
  set(zed_interfaces_SOURCE_PREFIX /home/robotixx_user/human-pov-navigation/src/zed-ros-wrapper/zed-ros-interfaces)
  set(zed_interfaces_DEVEL_PREFIX /home/robotixx_user/human-pov-navigation/devel)
  ...
  set(zed_interfaces_INSTALL_PREFIX /home/robotixx_user/human-pov-navigation/install)
...
if(NOT "/home/robotixx_user/human-pov-navigation/devel/include;/home/robotixx_user/human-pov-navigation/src/zed-ros-wrapper/zed-ros-interfaces/include " STREQUAL " ")
  set(zed_interfaces_INCLUDE_DIRS "")
  set(_include_dirs "/home/robotixx_user/human-pov-navigation/devel/include;/home/robotixx_user/human-pov-navigation/src/zed-ros-wrapper/zed-ros-interfaces/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'zed_interfaces' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotixx_user/human-pov-navigation/src/zed-ros-wrapper/zed-ros-interfaces/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robotixx_user/human-pov-navigation/devel/lib;/opt/ros/noetic/lib)
