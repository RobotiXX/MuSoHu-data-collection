...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_pcl_SOURCE_PREFIX /home/robotixx_user/human-pov-navigation/src/velodyne/velodyne_pcl)
  set(velodyne_pcl_DEVEL_PREFIX /home/robotixx_user/human-pov-navigation/devel)
  ...
  set(velodyne_pcl_INSTALL_PREFIX /home/robotixx_user/human-pov-navigation/install)
...
if(NOT "/home/robotixx_user/human-pov-navigation/src/velodyne/velodyne_pcl/include " STREQUAL " ")
  set(velodyne_pcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/robotixx_user/human-pov-navigation/src/velodyne/velodyne_pcl/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_pcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotixx_user/human-pov-navigation/src/velodyne/velodyne_pcl/${idir}'.  ${_report}")
    endif()
